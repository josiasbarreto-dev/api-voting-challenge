...
public class VotingSessionServiceImplTest {
    ...
    void shouldOpenVotingSessionSuccessfullyWhenAgendaIsPending() {
        ...
        VotingSessionResponse result = votingSessionService.openVotingSession(votingSessionRequest);
        ...
        verify(votingSessionMapper).toDto(any(VotingSession.class));
    ...
    void shouldThrowAgendaNotFoundExceptionWhenAgendaDoesNotExist() {
        var votingSessionRequest = VotingSessionFixtures.createInvalidVotingSessionRequestBuilder()
                .agendaId(INVALID_ID)
                .build();
